...
void normalize_image_neon(uint8_t* input_image, float* output_image, int width, int height) {
    ...
    float32x4_t v_recip_max_val = vdupq_n_f32(1.0f / 255.0f); // Reciprocal of max value
    ...
    for (int i = 0; i < num_pixels; i += 16) {
        ...
        v_pixels_f32_0 = vmulq_f32(v_pixels_f32_0, v_recip_max_val);
        v_pixels_f32_1 = vmulq_f32(v_pixels_f32_1, v_recip_max_val);
        v_pixels_f32_2 = vmulq_f32(v_pixels_f32_2, v_recip_max_val);
        v_pixels_f32_3 = vmulq_f32(v_pixels_f32_3, v_recip_max_val);
